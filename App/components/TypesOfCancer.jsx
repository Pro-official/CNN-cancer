      ...
      <section class="bg-white dark:bg-[#1e403c]">
        <div class="container lg:max-w-6xl py-40 mx-auto">
          <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">
            ...
            <span class="underline decoration-[#f6f2a5]">Components</span>
          </h1>
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div class="p-8 mt-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
            ...
            <div class="p-8 mt-16 bg-[#141617] space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
              <span class="inline-block text-blue-500 dark:text-blue-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-8 h-8"
